        ...
        <div class="flex justify-between">
            ...
            <div class="flex items-center">
                ...
                <button data-dropdown class="flex items-center px-3 py-2 focus:outline-none hover:bg-gray-200 hover:rounded-md" type="button" x-data="{ open: false }" @click="open = true" :class="{ 'bg-gray-200 rounded-md': open }">
                    ...
                    <img src="/images/super.jpg" alt="Profile" style="max-width: 25%; height: auto;" alt="Profle" class="h-8 w-8 rounded-full">
                    @endif
                    @if(auth()->user()->type == 'user')
                    <img src="/images/user.png" alt="Profile" style="max-width: 25%; height: auto;" alt="Profle" class="h-8 w-8 rounded-full">
                    @endif
                    ...
                    <div data-dropdown-items class="text-sm text-left absolute top-0 right-0 mt-16 mr-4 bg-white rounded border border-gray-400 shadow" x-show="open" @click.away="open = false">
                        <ul>
                            <li class="px-4 py-3 border-b hover:bg-gray-200"><a href="/profile/edit">My Profile</a></li>
            ...
            <div class="sidebar text-center bg-gray-900">
                <div class="text-gray-100 text-xl">
                    <div class="p-2.5 mt-1 flex items-center">
                        ...
                        <h1 class="font-bold text-gray-200 text-[15px] ml-3">Gérant</h1>
                        @endif
                        @if(auth()->user()->type =='user')
                        <h1 class="font-bold text-gray-200 text-[15px] ml-3">Caissier</h1>
                        @endif
                    </div>
                ...
                <a href="{{ route('invoices') }}">
                    ...
                    <i class="bi bi-receipt"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Commandes</span>
                    </div>
                </a>
                @if(auth()->user()->type == 'superadmin' || auth()->user()->type == 'admin')
                ...
                <a href="{{ route('taxs') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        ...
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Tax</span>
                    </div>
                </a>
...
<!-- 
                ...
                <a href="{{ route('customers') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Customers</span>
                    </div>
                </a>
                ...
                <a href="{{ route('commandes') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Commande</span>
                    </div>
                </a>
                <a href="{{ route('sales') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Sale</span>
                    </div>
                </a>
                @endif
                @if(auth()->user()->type =='superadmin')
